# Generated by Powerlevel10k configuration wizard on 2020-01-19 at 06:24 WIB.
...
# 2 lines, dotted, right frame, dark, sparse, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_SIGNAL="echo : \$(nmcli device wifi | grep yes | awk '{print \$8}')"
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_SIGNAL_BACKGROUND="blue"
  typeset -g POWERLEVEL9K_CUSTOM_WIFI_SIGNAL_FOREGROUND="yellow"
  typeset -g POWERLEVEL9K_IP_INTERFACE=wlp3s0
